...
module InstructionBasedAttacker (C: CacheAD.S) : CacheAD.S = struct
...
module OneInstructionInterrupt(C:CacheAD.S):CacheAD.S =
struct
...
module OneTimeInterrupt(C:CacheAD.S):CacheAD.S =
struct
